...
const NODES = [
  ...
  },
  {
    ...
    manualSources: [
      ...
      'CONTEXT: JWC Listed Areas (lmalloyds.com) — no longer carried as a series; it did not score and the country list has not moved. JWLA-033 (3 Mar 2026) added Bahrain, Kuwait, Oman, Qatar, Djibouti. JWLA-034 (29 Jul 2026) extended the Red Sea boundary from 18°N to 25.5°N, enclosing Yanbu, two days after Jazan went down, and deleted Pakistan. JWLA-035 (16 Sep 2026) amended the Black Sea only — the Gulf listing is unchanged since 29 Jul despite the insurance multiple reaching 40x. Note: LMA URLs carry a /2025/06/ path for 2026 documents; that is a CMS artefact, not a date.',
