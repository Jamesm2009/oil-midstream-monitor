...
const NODES = [
  ...
  },
  {
    ...
    category: 'physical',
    summary: 'Hormuz, Bab el-Mandeb, Suez, Cape — automated PortWatch + AIS',
  ...
  },
  {
    ...
    phase: 1,
    manualSources: [
      'FRED / EIA — automated (WTI, Brent, crack spreads)',
  ...
  },
  {
    ...
    phase: 1,
    manualSources: [
      'EIA — automated (US crude exports weekly/monthly, US crude production weekly)',
      'Baker Hughes — US oil rig count (manual, weekly Friday release)',
