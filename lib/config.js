...
const NODES = [
  ...
  },
  {
    ...
    series: [
      { key: 'hormuz_portwatch', label: 'Hormuz transits (PortWatch)', unit: '/day', manual: false, cadence: 'daily', source: 'straits.live' },
      ...
      { key: 'bab_portwatch', label: 'Bab el-Mandeb (PortWatch)', unit: '/day', manual: false, cadence: 'daily', source: 'straits.live' },
      { key: 'suez_portwatch', label: 'Suez (PortWatch)', unit: '/day', manual: false, cadence: 'daily', source: 'straits.live' },
      { key: 'cape_portwatch', label: 'Cape of Good Hope (PortWatch)', unit: '/day', manual: false, cadence: 'daily', source: 'straits.live' },
