...
const NODES = [
  ...
  },
  {
    ...
    phase: 2,
    series: [
      { key: 'hormuz_transits', label: 'Hormuz daily transits', unit: '/day', manual: true, cadence: 'assessment' },
  ...
  },
  {
    ...
    series: [
      ...
      { key: 'cushing', label: 'Cushing OK crude stocks', unit: 'M bbl', manual: false, cadence: 'weekly', source: 'EIA', eiaId: 'PET.W_EPC0_SAX_YCUOK_MBBL.W' },
