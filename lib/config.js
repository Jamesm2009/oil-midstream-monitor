...
const NODES = [
  ...
  },
  {
    ...
    phase: 2,
    manualSources: [
      'Windward AI MIOC dashboard — Hormuz (daily transits, dark transits)',
      'Windward AI MIOC dashboard — Bab el-Mandeb crossings (8-day rolling)',
      'Windward AI MIOC dashboard — Suez crossings (8-day rolling)',
      'Panama Canal Authority — daily transit data (Phase 2 automation)',
    ],
    series: [
      { key: 'hormuz_outbound', label: 'Hormuz outbound', unit: '/day', manual: true, cadence: 'weekly' },
      { key: 'hormuz_inbound', label: 'Hormuz inbound', unit: '/day', manual: true, cadence: 'weekly' },
      { key: 'hormuz_dark', label: 'Hormuz dark transits', unit: '/day', manual: true, cadence: 'weekly' },
      { key: 'bab_outbound', label: 'Bab el-Mandeb outbound (8d)', unit: '/8d', manual: true, cadence: 'weekly' },
      { key: 'bab_inbound', label: 'Bab el-Mandeb inbound (8d)', unit: '/8d', manual: true, cadence: 'weekly' },
      { key: 'suez_outbound', label: 'Suez outbound (8d)', unit: '/8d', manual: true, cadence: 'weekly' },
      { key: 'suez_inbound', label: 'Suez inbound (8d)', unit: '/8d', manual: true, cadence: 'weekly' },
    ],
  },
  {
    id: 'n3',
  ...
  },
  {
    ...
    phase: 3,
    manualSources: [
      "Lloyd's List / TradeWinds — war-risk premium quotes",
      'Joint War Committee bulletins (via trade press) — listed areas',
