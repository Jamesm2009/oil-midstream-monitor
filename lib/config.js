...
const NODES = [
  ...
  },
  {
    ...
    thresholdInfo: [
      ...
      'RED: TD3C above $500K/day (freight at crisis levels)',
      'AMBER: TD3C above $250K/day (freight elevated)',
      'NOTE: floating-storage bands are an absorption test and read low in a scarcity phase — freight is the counterweight',
    ...
    series: [
      ...
      { key: 'vlcc_spot', label: 'TD3C benchmark (Yanbu-referenced, runs ~$5/bbl rich)', unit: '$/day', manual: true, cadence: 'weekly' },
